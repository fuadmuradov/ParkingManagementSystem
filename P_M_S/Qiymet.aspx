<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qiymet.aspx.cs" Inherits="P_M_S.Qiymet" %>
        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <td> <asp:Button ID="Btn4" runat="server" class="btn btn-secondary" Text="Ödəyin" OnClick="Delete_Click"/></td>
                </tbody>
            </table>
