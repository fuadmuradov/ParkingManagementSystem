<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hesabat.aspx.cs" Inherits="P_M_S.Hesabat" %>
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-4">
						<h2>Nəqliyyat <b>Məlumatları</b></h2>
					</div>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                   <label id="lbl_data3" runat="server"></label>
                    <td> <asp:Button ID="Btn4" runat="server" class="btn btn-secondary" Text="Məlumatları Sil" OnClick="Delete_Click"/></td>
                </tbody>
            </table>
